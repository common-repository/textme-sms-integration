...
Enter the needed credentials. Define the events to trigger the SMS submission. Write custom messages to be sent to your users. Increase user engagment using dynamic fields inside your message to create personalized messages.

= TextMe SMS Features =

* **SMS Provider Gateway** - Send SMS messages and notification directly from your WordPress dashboard using TextMe SMS service.
...
* **WooCommerce** - Send SMS when a new order received, when an order is marked as completed, when an order cancel or waiting for payment, send sms to custom order status , and send custom sms to client from order notes section.

* **Contact Form 7** - Send SMS on form submition.

* **Elementor Forms** - Send SMS on form submition.
...
= 1.8.9 =
* Fix: Security and best practice.
...
= 1.8.4 =
* WooCommerce support to custom order status
* minor bug fix in settings page

= 1.8.3 =
* Elementor forms support

= 1.8.2 =
* minor bug fix in contact form 7 script

= 1.8 =
* Send sms from woocommerce customer notes
* Admin layout validation
