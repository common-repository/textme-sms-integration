...
$balance        = isset( $balance->balance ) ? (string)$balance->balance : '';
            ...
            <div id="postbox-container-1" class="postbox-container">
                ...
                <div class="meta-box-sortables">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <p><?php esc_html_e( 'SMS balance:', 'textme-sms-integration' ); ?> <span
                                        class="textme-balance"><?php echo floatval( $balance ); ?></span></p>
                                        ...
                                        <td>
                                            <input type="text" name="sms_user_name" id="sms_user_name" required
                                                   value="<?php if ( $textme_account['sms_user_name'] ) {
												       echo esc_attr($textme_account['sms_user_name']);
											       } ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="password" name="sms_pass" id="sms_pass" required
                                                   value="<?php if ( $textme_account['sms_pass'] ) {
												       echo esc_attr($textme_account['sms_pass']);
											       } ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="sms_phone" id="sms_phone" pattern=".{10,}" required
                                                   title="<?php esc_html_e( '10 Digits', 'textme-sms-integration' ); ?>"
                                                   value="<?php if ( $textme_account['sms_phone'] ) {
												       echo esc_attr($textme_account['sms_phone']);
											       } ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label for="sms_from"><?php esc_html_e( 'Source/Caller ID:', 'textme-sms-integration' ); ?></label>
                                        </td>
                                        <td>
                                            <input type="text" name="sms_from" id="sms_from" pattern="[a-zA-Z0-9-]+"
                                                   required
                                                   title="<?php esc_html_e( '10 Digits numbers or english letters', 'textme-sms-integration' ); ?>"
                                                   value="<?php if ( $textme_account['sms_from'] ) {
												       echo esc_attr($textme_account['sms_from']);
											       } ?>"/>
                                        </td>
                                    </tr>
                                    <tr>
